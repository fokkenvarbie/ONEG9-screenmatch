...
- **Funcionalidades:**
  ...
  - **Sistema de avaliações:** Permite registrar múltiplas notas e calcula a média automaticamente.
  - **Cálculo de maratona:** Soma a duração total de todos os títulos adicionados (filmes e séries), exibindo quanto tempo o usuário precisaria para assistir tudo.
